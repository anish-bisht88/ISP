...
enum Global {
    ...
    static let leftPlayerWin = "https://codermerlin.com/users/anish-bisht/stupidRtrans.png"
    static let rightPlayerWin = "https://codermerlin.com/users/anish-bisht/stupidLtrans.png"
